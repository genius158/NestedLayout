...
public class NestedFrameLayoutWithFling extends FrameLayout implements NestedScrollingChild, NestedScrollingParent {
    ...
    public NestedFrameLayoutWithFling(Context context) {
        this(context, null, -1);
    }

    public NestedFrameLayoutWithFling(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public NestedFrameLayoutWithFling(Context context, AttributeSet attrs, int defStyle) {
